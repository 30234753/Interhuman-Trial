        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 text-realtalk-blue/80">
            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
              ...
              <p className="text-sm leading-relaxed">
                We store the conversation transcript/chat log and emotion / non-verbal tags generated during the session for up to 30 days, to evaluate and improve the prototype.
              </p>
            </div>
            ...
            <div className="bg-realtalk-blue/10 rounded-lg p-4 border border-realtalk-blue/30">
              ...
              <ul className="space-y-2 text-sm text-realtalk-blue/70 list-disc list-inside">
                ...
                <li>Storage of the transcript/chat log and generated tags for prototype evaluation (up to 30 days)</li>
              </ul>
            </div>
